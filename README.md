...
**Recorte da v0.203.** Manual do Fundamento na **v7.24**, e o Manual da Guilda em **18 capítulos**, 256 páginas.
...
| pasta | o que é |
|---|---|
| `regra/` | as **vinte e seis peças** de mecânica, na ordem numérica |
...
| `manual/` | o **Fundamento** — o subsistema de técnica e feitiço, fechado e validado. `.docx` e `.pdf` na **v7.24** |
...
~~**2 — O `.pdf` do manual está atrasado em relação ao `.docx`.**~~ **Resolvido na v0.93:** o `.pdf` deixou de ser exportado a mão e sai junto. *Os dois estão na* **v7.24**, *e pode usar qualquer um.*
