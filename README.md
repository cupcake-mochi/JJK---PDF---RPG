...
**Recorte da v0.221.** Manual do Fundamento na **v7.26**, e o Manual da Guilda em **18 capítulos**, 256 páginas.
...
| `manual/` | o **Fundamento** — o subsistema de técnica e feitiço, fechado e validado. `.docx` e `.pdf` na **v7.26** |
...
~~**2 — O `.pdf` do manual está atrasado em relação ao `.docx`.**~~ **Resolvido na v0.93:** o `.pdf` deixou de ser exportado a mão e sai junto. *Os dois estão na* **v7.26**, *e pode usar qualquer um.*
