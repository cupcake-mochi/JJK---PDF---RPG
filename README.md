...
**Recorte da v0.140.** Manual do Fundamento na **v7.12**, e o Manual da Guilda em **18 capítulos**, 236 páginas.
...
| `livro/` | **o Manual da Guilda inteiro** — o texto de mesa que a v0.102 decidiu escrever direto no PDF. 18 capítulos, 236 páginas, `.pdf` e `.docx` de revisão |
