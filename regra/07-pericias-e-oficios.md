...
**Fase 4, sétima peça.** O quadro completo do que o personagem sabe fazer fora da técnica.
Versão v0.16, ampliada na v0.17 e na v0.22, corrigida na v0.24 — 08/08/2026

Esta peça substitui a seção 3 e a seção 4 da peça 4. O resto daquela peça — a escada de dificuldade, falhar move a cena, ajudar e rolar em grupo, o ataque de oportunidade — continua valendo inteiro.

---

## 1. Duas listas, não uma

O personagem tem **perícias** e **ofícios**. São coisas diferentes e a diferença é fácil de errar, então ela vem primeiro.
...
**Ofício** é uma prática que alguém te ensinou. Ele não pertence a atributo nenhum — o atributo muda conforme o que você está fazendo com ele.
...
A regra prática: **se é uma ferramenta ou um procedimento que alguém te ensinou passo a passo, é ofício.** Ferramenta pode ser a chave de fenda, o papel de talismã ou o formulário certo — Burocracia é ofício pelo mesmo motivo que Forja é.
...
Duas diferenças, e as duas têm motivo.

**A perícia tem atributo fixo; o ofício não.** Forjar uma lâmina é Força. Falsificar uma assinatura é Destreza. Saber qual selo o papel pede é Inteligência — e as três coisas são o mesmo ofício. O mestre escolhe o atributo na hora, do mesmo jeito que escolhe a dificuldade.

**Perícia sem treino você tenta; ofício sem treino, não.** Qualquer um pode tentar escalar e falhar. Ninguém forja uma lâmina por tentativa. Quando o mestre achar que dá para improvisar — dirigir um carro automático em linha reta, fazer um curativo torto —, ele libera a rolagem sem a maestria.
...
Ela quer entrar num depósito sem ser vista. Furtividade é Destreza: `d20 + 4 + 1 = d20 + 5`. Contra a CD 18 de uma média, ela passa em 40% das vezes.

Chegando na porta, ela usa Arrombamento. O mestre decide que forçar aquela tranca é trabalho de mão, então cobra Destreza: `d20 + 4 + 1` de novo. Se fosse uma tranca eletrônica, ele teria cobrado Inteligência, e o mesmo ofício renderia `d20 + 2 + 1` — três a menos, porque ela é boa com as mãos e não com o sistema.

## 3. Inteligência sabe, Essência percebe

Esta frase decide onde cada perícia mora, e ela existe porque a divisão anterior não sobrevivia à mesa.

**Inteligência é o que você estudou.** O catálogo de maldições, o que aconteceu, como o corpo funciona, quem manda em quem.

**Essência é o que você capta.** A energia no ar, o barulho no corredor, a mentira na voz de alguém.

Antes da v0.16, Sentir Energia e Percepção moravam em Inteligência, e isso vinha de uma decisão boa que envelheceu mal: quando Sabedoria e Carisma fundiram em Essência, a percepção foi para Inteligência para tirar dela o papel de atributo-depósito.

Mas Essência não *sabe* nada — ela **sente**. Sentir energia amaldiçoada é a sua energia reagindo à de outro, e isso não é análise, é ressonância. Na obra, quem sente bem não é quem estuda mais: é o Gojo com os Seis Olhos, é a Nobara, é o instinto do Todo. E existe o contrário — gente que sabe tudo de teoria e não sente nada chegando.

O ganho prático é maior do que parece. Comparando o **peso de mesa** de cada atributo — quanto do que se rola numa campanha depende dele —, e não a contagem crua:

| | perícias em Int | perícias em Ess | peso de mesa (Int / Ess) |
|---|---|---|---|
| antes | 10 de 20 | 5 de 20 | **56% / 21%** |
| agora | 11 de 23 | 7 de 23 | **39% / 39%** |

Inteligência ficou com *mais* perícias do que antes e **vale menos**, porque as duas que saíram são as duas mais roladas da mesa. Contagem não é valor.

## 4. As vinte e três perícias

Nenhuma delas mora em Constituição. Constituição governa os **pontos de vida** e o Teste de Resistência Vigor, e isso é trabalho suficiente para um atributo.

*Vale registrar que essa frase só passou a ser verdade na v0.17.* Até lá, três documentos diziam que Constituição governava vida e nenhum dizia quanto — a única fórmula existente, a do manual, não tinha atributo nenhum. O argumento que tirava as perícias dela era um trabalho que ela não tinha. A fórmula está na peça 1, seção 5.1.
...
**Atletismo** — correr, escalar, nadar, saltar, carregar alguém que não consegue andar.

**Acrobacia** — equilíbrio, cair sem se machucar, escapar de um agarrão, passar por espaço apertado.
**Furtividade** — mover-se sem ser visto nem ouvido.
**Pontaria** — acertar o que é pequeno, o que está longe ou o que se mexe, fora de uma rolagem de ataque.
**Prestidigitação** — mão rápida: esconder um objeto, tirar do bolso alheio, trocar uma coisa por outra na frente de quem está olhando.

**Investigação** — vasculhar, deduzir, ligar duas pistas que ninguém tinha ligado.
**Intuição** — ler a pessoa pelo que ela faz: a inconsistência na história, o detalhe que não fecha, a motivação atrás do pedido. É dedução sobre gente, e por isso é Inteligência — perceber que alguém está nervoso é Percepção.
**Ocultismo** — maldições, técnicas conhecidas, barreiras, o funcionamento da energia amaldiçoada. O lado técnico.
**Religião** — xintoísmo, budismo, exorcismo, templo, ritual, o que os selos querem dizer. O lado sagrado, que é de onde o jujutsu veio antes de virar instituição.
**História** — o que aconteceu e quem estava lá, no mundo comum e no registro das famílias.
**Hierarquia** — os clãs, a política, quem manda em quem e quem deve o quê a quem. Diz o que você pode pedir, a quem, e o que vai custar.
**Medicina** — ferimento, veneno, doença, corpo. O saber; a prática de campo é o ofício Herbalismo.
**Sobrevivência** — aguentar o ambiente, achar água e abrigo, se orientar, e **seguir um rastro**, seja pegada ou resíduo de energia.
**Natureza** — planta, bicho, clima, terreno. O que é o quê, o que é venenoso, quando a chuva vem.
**Lidar com Animais** — acalmar, montar, conduzir, mandar num bicho. Vale para o que não é bicho mas se comporta como um.
**Tecnologia** — computador, câmera, rede, equipamento moderno.

**Sentir Energia** — perceber energia amaldiçoada. Notar o feiticeiro escondido, medir o tamanho de uma maldição antes de encostar nela, sacar que alguém está prestes a conjurar. É a perícia mais rolada da mesa, e em Jujutsu Kaisen quem não sente energia morre por não ter sentido.
**Percepção** — notar o mundano: som, cheiro, movimento, a coisa que está fora do lugar, a pessoa suando frio.
**Persuasão** — convencer, negociar, conseguir que façam o que você quer porque querem.
**Enganação** — mentir, blefar, se passar por outro.
**Intimidação** — ameaçar, dominar pela presença, fazer alguém **recuar**.
**Atuação** — representar, cantar, tocar para uma plateia, sustentar um personagem que não é você.
**Provocar** — tirar alguém do sério, fazer perder a linha, forçar a vir para cima de você. É o oposto de Intimidação: uma faz recuar, a outra faz **avançar**.

### Onde foi parar "analisar a técnica do inimigo"

Não existe perícia para isso, e é de propósito — são duas coisas diferentes e cada uma já tem casa.

**Ocultismo** reconhece o que você está vendo porque você conhece o catálogo. *"Isso é uma técnica de troca, e troca sempre tem um custo."*

**Sentir Energia** lê como a energia se move, mesmo sem saber o nome do que está acontecendo. *"Ela gasta muito no começo de cada golpe. Se eu forçar três seguidos, ela seca."*

O Nanami faz a primeira. O Todo faz a segunda.

### Sobre o nome "Provocar"
...
**Herbalismo** — planta que cura, planta que mata, chá, unguento, e o que dá para fazer no mato quando não tem hospital.
...
**O Evocador entalha o corpo que vai receber a invocação.** É o ofício que dá razão de existir para os shikigami de madeira e para a boneca que anda.
...
**Força continua com uma só, e a lista não conserta isso.** Nenhuma perícia nova cabia nela sem enchimento: correr, escalar e carregar já são Atletismo, e aguentar dor e fome é leitura de Constituição em qualquer mesa. O segundo trabalho de Força tem que vir de fora do quadro de perícias — o requisito de arma e de proteção da peça 6 já é um, e somar em pontos de vida continua sendo o conserto barato se doer no playtest.

Três perícias antigas foram partidas em duas: **Ocultismo** perdeu o lado sagrado para **Religião**, **Sobrevivência** perdeu o lado de conhecimento para **Natureza**, e **Táticas** deixou de existir porque o trabalho dela já estava coberto por Ocultismo e Sentir Energia.
